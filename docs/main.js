    ...
    <div className="min-h-screen bg-slate-50 text-slate-600 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${isScrolled ? 'bg-white/90 backdrop-blur-md border-slate-200 py-3 shadow-sm' : 'bg-transparent border-transparent py-5'}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-full transition-all shadow-md hover:shadow-lg">
              <Github size={16} />
              <span>GitHub</span>
            </a>
          </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up delay-300">
            ...
            <a href="https://github.com" className="px-8 py-3 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-lg font-medium transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2">
      ...
      <section id="tips" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="mt-16 p-8 bg-blue-50 rounded-2xl border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-6">
             ...
             <a href="#" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors shadow-sm">
               前往 Prj1 分支
             </a>
           </div>
        </div>
      ...
      <footer className="py-12 bg-slate-50 border-t border-slate-200 text-center">
         ...
         <div className="flex justify-center gap-8 text-sm font-medium text-slate-600">
            <a href="#" className="hover:text-blue-600 transition-colors">GitHub 仓库</a>
            <a href="#" className="hover:text-blue-600 transition-colors">提出 Issue</a>
            <a href="#" className="hover:text-blue-600 transition-colors">课程主页</a>
         </div>
      </footer>
    </div>
  );
